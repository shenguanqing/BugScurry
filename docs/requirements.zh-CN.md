...
| F-BUG-05 | 点击「全部清除」：清空所有虫子（并停雨） | P0 |
...
| F-WX-02 | 托盘天气：停雨 / 随机 / 小雨 / 中雨 / 大雨 / 暴雨 / 雷阵雨 | P0 |
| F-WX-03 | 托盘勾选当前雨档；每场重掷风向；雷电与雨声 | P1 |
| F-WX-04 | 设置「随机下雨」自动节奏；手动选择会重置时钟 | P1 |
| F-WX-05 | 雨声与「捏死音效」共用总开关 | P1 |
...
| F-SET-08 | 一键「全部清除」（虫子、食物、痕迹，并停雨） | P0 |
| F-SET-09 | 一键「重新生成」 | P0 |
| F-SET-10 | 开机启动 | P1 |
